...
const Tab = ({nav, activeTab}) => {
    ...
    <View style={[styles.container]}>
        ...
        <TouchableOpacity style={styles.sideTab} onPress={() => {navigation.navigate("SettingScreen")}}><Icon color={aTab == 'settings' ? "#3CB371" : "#000000"} style={{}} name="settings-outline" size={windowWidth/12} title="" /></TouchableOpacity>
