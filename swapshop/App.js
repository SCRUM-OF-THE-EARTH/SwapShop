        ...
        <themeContext.Provider value={mode === true ? theme.dark : theme.light}>
         <NavigationContainer>
            <RootStack.Navigator screenOptions={{headerShown:false}}>
                ...
                <RootStack.Screen name = "addItemScreen" component={AddItemScreen} options={({ route }) => ({headerShown:true, title: route.params.heading, headerStyle:{backgroundColor:"#3CB371"}})}/>
